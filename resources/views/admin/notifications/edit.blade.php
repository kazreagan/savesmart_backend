                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="form-check form-check-inline">
                                    {!! Form::checkbox('send_to_all', '1', $notification->is_broadcast, ['class' => 'form-check-input', 'id' => 'send_to_all']) !!}
                                    {!! Form::label('send_to_all', 'Send to All Users', ['class' => 'form-check-label']) !!}
                                </div>
                                <div id="user_select_container" style="{{ $notification->is_broadcast ? 'display: none;' : '' }}">
                                    {!! Form::select('user_id', $users, null, ['class' => 'form-control', 'placeholder' => 'Select User', 'required' => !$notification->is_broadcast, 'id' => 'user_id']) !!}
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('type', ['Information' => 'Information', 'Success' => 'Success', 'Warning' => 'Warning', 'Error' => 'Error'], null, ['class' => 'form-control', 'required']) !!}
                        </div>
